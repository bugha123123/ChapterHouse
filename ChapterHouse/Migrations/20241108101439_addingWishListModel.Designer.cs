...
namespace ChapterHouse.Migrations
{
    ...
    [Migration("20241108101439_addingWishListModel")]
    partial class addingWishListModel
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("ChapterHouse.Models.User", b =>
                {
            ...
            modelBuilder.Entity("ChapterHouse.Models.WishList", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("ChapterHouse.Models.WishList", b =>
                {
                    ...
                    b.HasOne("ChapterHouse.Models.Books", "books")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("ChapterHouse.Models.User", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
